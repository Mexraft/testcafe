...
import HealthcareFlowchart from "../flow/HealthcareFlowchart";
    ...
    <div className="space-y-8 animate-fade-in">
      <div className="text-center">
        ...
        <p className="mt-2 text-lg text-muted-foreground">
          Confirm the AI's interpretation of your requirements before generating
          test cases.
        </p>
      </div>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
        <Card className="shadow-lg">
          ...
          <CardContent>
            <Alert className="mb-4 text-sm">
              ...
              <AlertDescription>
                Feel free to edit the summary below to refine the AI's
                understanding. The flowchart and subsequent test cases will be
                based on this text.
              </AlertDescription>
            </Alert>
            <Textarea
        ...
        <Card className="shadow-lg lg:sticky lg:top-8">
          ...
          <CardContent>
            ...
            <HealthcareFlowchart data={flowchartData} />
          </CardContent>
        </Card>
      </div>
      <Card>
